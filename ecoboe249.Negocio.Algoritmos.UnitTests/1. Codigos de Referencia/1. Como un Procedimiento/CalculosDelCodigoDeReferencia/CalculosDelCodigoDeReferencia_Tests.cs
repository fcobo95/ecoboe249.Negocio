...
using ecoboe249.Negocio.Algoritmos.ComoUnProcedimiento.CodigosDeReferencia;

namespace ecoboe249.Negocio.Algoritmos.UnitTests.ComoUnProcedimiento.CodigosDeReferencia_Tests
{
    [TestClass]
