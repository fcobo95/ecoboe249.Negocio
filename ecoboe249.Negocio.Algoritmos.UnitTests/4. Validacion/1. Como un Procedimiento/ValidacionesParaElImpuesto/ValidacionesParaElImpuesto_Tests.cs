...
using ecoboe249.Negocio.Algoritmos.ComoUnProcedimiento.ValidacionesImpuesto;

namespace ecoboe249.Negocio.Algoritmos.UnitTests.ComoUnProcedimiento.Validaciones_Tests
{
    [TestClass]
