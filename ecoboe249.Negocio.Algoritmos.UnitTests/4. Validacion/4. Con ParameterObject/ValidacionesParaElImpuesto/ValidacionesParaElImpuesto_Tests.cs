...
using ecoboe249.Negocio.Algoritmos.ConParameterObject.ValidacionesImpuesto;

namespace ecoboe249.Negocio.Algoritmos.UnitTests.ConParameterObject.Validaciones_Tests
{
    [TestClass]
